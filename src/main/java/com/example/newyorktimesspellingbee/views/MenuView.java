...
public class MenuView extends View{
    ...
    private final String LOGO_PATH = "com/example/newyorktimesspellingbee/logo.png";
    ...
    private void init() {
        ...
        vBox.setBackground(new Background(new BackgroundFill(BACKGROUND_COLOR, CornerRadii.EMPTY, Insets.EMPTY)));
